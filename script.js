  ...
  */
  (function() {
    ...
    if (location.hostname.slice(0, 6) === '10.0.0') {
      ...
      $('head meta')
        .last()
        .append('<script src="local/js/google/css3-mediaqueries.js"' +
          ' type="text/javascript"></script>');

      $('head meta')
        .last()
        .append('<script src="local/js/modernizr/modernizr.min.js"' +
          ' type="text/javascript"></script>');
      ...
      $('head meta')
        .last()
        .append('<link rel="icon"' +
          ' href="local/media/images/fZpm3YM.jpg" />');
      ...
      $('head meta')
        .last()
        .append('<script src="https://css3-mediaqueries-js.googlecode.com/svn/trunk/' +
          'css3-mediaqueries.js" type="text/javascript"></script>');

      $('head meta')
        .last()
        .append('<script src="https://cdnjs.cloudflare.com/ajax/libs/' +
          'modernizr/2.7.1/modernizr.min.js" type="text/javascript"></script>');

      $('head meta')
        .last()
        .append('<link rel="stylesheet"' +
          ' href="https://cdnjs.cloudflare.com/ajax/' +
          'libs/font-awesome/4.4.0/css/font-awesome.css" />');
      ...
      $('head meta')
        .last()
        .append('<link rel="icon"' +
          ' href="http://i.imgur.com/fZpm3YM.jpg" />');
