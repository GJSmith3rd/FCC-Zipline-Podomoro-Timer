...
$(document).ready(function() {
  ...
  if (location.host === '10.0.0.75:3039') {
    ...
    $('head script').last().append('<link rel="stylesheet/less"' +
      ' type="text/css" href="styles.less" />');
    $('head script').last().append('<script async=false >less = {env: "development", ' +
      'async: false, fileAsync: false, poll: 1000, functions: {}, dumpLineNumbers: "comments",' +
      ' relativeUrls: false}; </script>');
    $('head script').last().append('<script async=false src="less.min.js" type="text/javascript"></script>');
    $('head script').last().append('<script async=false>less.watch();</script>');

  } else {
    //use local css generated by gulp tasks
    $('head script').last().append('<link async="false" rel="stylesheet" href="styles.css" />');
